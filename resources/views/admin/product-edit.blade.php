  ...
  <div class="admin_main_container p-4"> 
    <div class="dashboard_cards d-flex justify-content-between mb-4 mt-5 pt-3">
        ...
        <ul class="breadcrumbs list-unstyled w-25 d-flex justify-content-end align-items-center">
          ...
          <li><span class="text-tiny">> Edit Product</span></li>
        </ul>
    </div>
    <div class="product_content">
      <div class="w-100 d-flex justify-content-between align-items-center">
        <form action="{{ route('admin.update.product') }}" method="POST" enctype="multipart/form-data" class="mt-4 w-100">
          @csrf
          @method('PUT')
          ...
          <div class="d-flex justify-content-between">
            <div class="w-50 bg-white p-3 me-3 rounded-2">
              <div class="m-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" tabindex="0" id="name" name="name" value="{{ $product->name }}" placeholder="Enter Product Name">
                @error('name')
              ...
              <div class="m-3">
                ...
                <input type="text" class="form-control @error('slug') is-invalid @enderror" tabindex="0" id="slug" name="slug" value="{{ $product->slug }}" placeholder="Enter Product Slug">
                @error('slug')
                <span class="invalid-feedback" role="alert">
                  <p>{{ $message }}</p>
                </span>
              ...
              <div class="m-3">
                ...
                <textarea type="text" rows="5" class="form-control @error('short_description') is-invalid @enderror" tabindex="0" id="short_description" name="short_description" placeholder="Enter Short Description">{{  $product->short_description }}</textarea>
                @error('s_description')
                <span class="invalid-feedback" role="alert">
                  <p>{{ $message }}</p>
                </span>
              ...
              <div class="m-3">
                ...
                <textarea type="text" rows="7" class="form-control @error('description') is-invalid @enderror" tabindex="0" id="description" name="description" placeholder="Enter Description">{{  $product->description }}</textarea>
                @error('description')
                <span class="invalid-feedback" role="alert">
                  <p>{{ $message }}</p>
                </span>
            ...
            <div class="w-50 bg-white p-3 ms-3 rounded-2">
                <div class="m-3">
                    ...
                    <div class="product_img py-3 rounded m-3 ms-0 visible" id="p_preview_container">
              ...
              <div class="m-3">
                ...
                <div class="w-100">
                  ...
                  <div class="product_img py-3 rounded m-3 ms-0 visible" id="g_preview_container">
                        <div class="product_input border-0 rounded" id="g_previewImage">
                            @if ($product->images)
                                @foreach (explode(",", $product->images) as $img)
                                <div class="item gitems">
                                    <img src="{{ asset('images/products') }}/{{ trim($img) }}" alt="{{$product->name}}">
                                </div>
                                @endforeach
                            @endif
                        </div>
              ...
              <div class="d-flex">
                <div class="m-3 w-50">
                  ...
                  <input type="text" class="form-control @error('regular_price') is-invalid @enderror" tabindex="0" id="regular_price" name="regular_price" value="{{ $product->regular_price }}" placeholder="Enter Regular Price">
                  @error('regular_price')
                  <span class="invalid-feedback" role="alert">
                    <p>{{ $message }}</p>
                  </span>
                ...
                <div class="m-3 w-50">
                  ...
                  <input type="text" class="form-control @error('sale_price') is-invalid @enderror" tabindex="0" id="sale_price" name="sale_price" value="{{ $product->sale_price }}" placeholder="Enter Sale Price">
                  @error('sale_price')
                  <span class="invalid-feedback" role="alert">
                    <p>{{ $message }}</p>
                  </span>
              ...
              <div class="d-flex">
                <div class="m-3 w-50">
                  ...
                  <input type="text" class="form-control @error('SKU') is-invalid @enderror" tabindex="0" id="SKU" name="SKU" value="{{ $product->SKU }}" placeholder="Enter SKU">
                  @error('SKU')
                  <span class="invalid-feedback" role="alert">
                    <p>{{ $message }}</p>
                  </span>
                ...
                <div class="m-3 w-50">
                  ...
                  <input type="text" class="form-control @error('quantity') is-invalid @enderror" tabindex="0" id="quantity" name="quantity" value="{{ $product->quantity }}" placeholder="Enter Quantity">
                  @error('quantity')
                  <span class="invalid-feedback" role="alert">
                    <p>{{ $message }}</p>
                  </span>
