                ...
                <div class="d-flex justify-content-evenly w-100">
                  ...
                  <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item" id="logout">
                      <a class="nav-link dropdown-toggle text-light mx-2" href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Admin, {{ Auth::guard('admin')->user()->full_name }}</a>
