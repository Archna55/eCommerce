...
@section('content')
    <style>
        ...
        /* Remove default arrows from number input for a clean UI */
                ...
                <div class="d-flex">
                    <div>
                        ...
                        <div class="g_img me-3 mb-3">
                            <img loading="lazy" src="{{ asset('images/products') }}/{{ $img }}" class="g_img object-cover group-hover:scale-110 transition duration-700" alt="">
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="px-5 py-4 w-50">
                    ...
                    <div class="pb-3 mb-4">
                        ...
                        <div class="d-flex items-center justify-between gap-2 px-1 mb-4">
                            ...
                            <!-- Add Button -->
                            <button type="button" class="addToCart btn btn-danger flex-grow text-white h-10 px-5 rounded-lg font-bold transition flex items-center justify-center">
