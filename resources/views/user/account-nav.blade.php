        ...
        <div class="collapse navbar-collapse d-flex justify-content-between w-75" id="navbarTogglerDemo01">
            <div class="d-flex justify-content-evenly w-100">
                <ul class="navbar-nav ms-3 me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light mx-2" href="#">Shop</a>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item" id="logout">
                        <a class="nav-link fw-semibold text-light mx-2" href="{{ route('login') }}" id="accountDropdown" role="button" aria-expanded="false"><i class="fa-solid fa-user"></i></a>
                    ...
                    @else
                        <li class="nav-item dropdown" id="logout">
                            <a class="nav-link fw-semibold text-light mx-2" href="{{ Auth::user()->role === 'Admin' ? route('admin.dashboard') : route('user.dashboard') }}" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
